...
public class AbrigoServiceTest {
    ...
    public void deveVerificarQuandoNaoHaAbrigo() throws IOException, InterruptedException {
        abrigo.setId(0L);
        String expectedNenhumAbrigoCadastrado = "Não há abrigos cadastrados.";
        ...
        String[] lines = baos.toString().split(System.lineSeparator());
        String actualNenhumAbrigoCadastrado = lines[0];

        Assertions.assertEquals(expectedNenhumAbrigoCadastrado, actualNenhumAbrigoCadastrado);
    }
